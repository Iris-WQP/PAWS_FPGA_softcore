...
#
# Generated by Vivado on Sun Apr 05 13:44:11 CST 2026
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../PAWS_softcore_ax7325b_vivado2018.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../PAWS_softcore_ax7325b_vivado2018.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/data/home2/qiupingw/Softcore/PAWS_softcore_ax7325b_vivado2018/PAWS_softcore_ax7325b_vivado2018.cache/compile_simlib/vcs"
  fi
