...
module double_adder(
  ...
  reg       [56:0] sum;
  (* use_dsp = "yes" *) wire [56:0] sum_add_wire = {1'd0, a_m} + {1'd0, b_m};
  (* use_dsp = "yes" *) wire [56:0] sum_sub_ab_wire = {1'd0, a_m} - {1'd0, b_m};
  (* use_dsp = "yes" *) wire [56:0] sum_sub_ba_wire = {1'd0, b_m} - {1'd0, a_m};
