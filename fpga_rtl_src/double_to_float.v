...
module double_to_float(
  ...
  reg round;
  reg sticky;
  (* use_dsp = "yes" *) wire [22:0] z_round_inc_wire = z_m[22:0] + 23'd1;
  (* use_dsp = "yes" *) wire [22:0] a_round_inc_wire = a[51:29] + 23'd1;
