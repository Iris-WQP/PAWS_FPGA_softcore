...
`define instr_read_width 88   //11*8//8 bit operand + 56bit opcode, window size
`define read_window_size 11   //(`instr_read_width/`instr_bram_width)
